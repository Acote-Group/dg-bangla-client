  ...
  return (
    <>
      <section className="bg-[#F8F8F8]">
        <div className="relative bg-[#F8F8F8] py-12">
          <div className="absolute inset-0 overflow-hidden">
            <div
              className="absolute inset-0 bg-[#F8F8F8]"
              style={{
                clipPath: "polygon(0px 0px, 100% 0px, 100% 75%, 0px 100%)",
              }}
            ></div>
          </div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-lg text-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                <svg
